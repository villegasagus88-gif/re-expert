...
>
> Redactado sobre una auditoría técnica del código fuente. **No constituye asesoramiento
> legal.**
...
> **[REVISIÓN LEGAL]** ⚠️ La carga de **Google Fonts desde servidores de Google
> transmite la dirección IP del visitante a un tercero en Estados Unidos antes de
> cualquier interacción o consentimiento**. En jurisdicciones europeas esta práctica fue
> objeto de sanciones bajo el RGPD. Dado que está prevista una expansión internacional,
> se recomienda evaluar **alojar las tipografías en el propio servidor**, lo que
> elimina la transferencia por completo y es un cambio técnico menor. Ver ítem R14 del
> reporte de riesgos.
...
la aplicación. Consultas: `contacto@re-expert.app`.
...
| # | Punto | A validar |
|---|---|---|
| 1 | 3 | Transferencia de IP a Google por Google Fonts antes del consentimiento. Evaluar alojamiento propio de las tipografías. |

### [CONFIRMAR CON TITULAR]
| # | Qué | Punto |
|---|---|---|
| 1 | Fecha de publicación | Encabezado |
| 2 | Verificar que no se incorporen herramientas de analítica sin actualizar este documento | 2.4 |
